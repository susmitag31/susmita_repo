...
if __name__ == '__main__':
    ...
    data_dir = Path('/home/ubuntu/FocusSeq2Seq-master/squad')
    data_dir_test=Path('/home/ubuntu/FocusSeq2Seq-master/squad_test')
    glove_dir = Path('/home/ubuntu/FocusSeq2Seq-master/glove')
    out_dir = Path('/home/ubuntu/FocusSeq2Seq-master/squad_out')
    #out_dir.mkdir()
   ...
   # with open(out_dir.joinpath('vocab.pkl'), 'wb') as f:
    ...
    test_df = preprocess_data(data_dir_test, 'test')
   ...
   # val_df.to_pickle(out_dir.joinpath('val_df.pkl'))
    test_df.to_pickle(out_dir.joinpath('test_df1.pkl'))
