...
def get_loader(config, data_dir):
    if config.task == 'QG':
        ...
        data_dir = current_dir.joinpath('/home/ubuntu/FocusSeq2Seq-master/squad_out/')
        ...
        test_df = pd.read_pickle(data_dir.joinpath('test_df1.pkl'))
        ...
        data_dir = current_dir.joinpath('/home/ubuntu/FocusSeq2Seq-master/cnndm_out/')
        with open(data_dir.joinpath('vocab.pkl'), 'rb') as f:
            word2id, id2word = pickle.load(f)
